...
$asunto_fijo="Red Hat: Información Relevante Sobre tu Registro";
        ...
        <td width='538' bgcolor='#ffffff' align='center'>
            <table border='0' cellpadding='0' cellspacing='0' width='83%'>
                <tr>
                    ...
                    <strong>Registro rechazado</strong><br>
<strong style='color:#0071c5'>Apreciable ".$nombreMail." ".$apellidoMail.":</strong>
<br><br>
Lamentamos informarte que el cupo m&aacute;ximo del evento ha llegado a su l&iacute;mite.<br>
Agradecemos tu comprensi&oacute;n, esperando contar con tu presencia en futuras ocasiones.
